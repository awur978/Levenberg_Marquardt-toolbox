...
%create feed forward neural network with 4 input, 1 hidden layer with 
%5 neurons each and 3 output
net = CreateNN([4 5 3]); %alternative: net = CreateNN([1,3,3,1],[0],[],[]);
...
figure;
subplot(311);plot(1:lv,Ytest(1,:),'o',1:lv,ytest_LM(1,:),'*');
title('Network''s Performance - Testing');
subplot(312);plot(1:lv,Ytest(2,:),'o',1:lv,ytest_LM(2,:),'*');
subplot(313);plot(1:lv,Ytest(3,:),'o',1:lv,ytest_LM(3,:),'*');
